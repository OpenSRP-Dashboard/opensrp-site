...
angular.module('opensrpSiteApp')
  .service('scheduleLogService', function ($http,$rootScope,Base64,OPENSRP_WEB_BASE_URL,Common, COUCHURL) {
        ...
        var couchUrl = "http://27.147.129.50:1234/192.168.19.55:5984/opensrp/_design/ScheduleLog/_view/testViewForDashboard?limit=20"; //COUCHURL + 
        ...
        this.dataFilter = function($scope){
          $scope.search = {};
        ...
        this.anmList = function($scope,data){
          var anms = new Array();
